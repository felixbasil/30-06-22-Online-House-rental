...
<html lang="en">
    ...
    <head>
        ...
        <link href="css2/dataTables.bootstrap4.css" rel="stylesheet">
        <style>
            .image-container {
                position: relative;
            }
                                                ...
                                                <div class="card-title mb-4">
                                                    <div class="d-flex justify-content-start">
                                                        <div class="image-container">
                                                            <img src="image/i2.jpg" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                                                                <div class="middle">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            <div class="tab-pane fade" id="connectedServices" role="tabpanel" aria-labelledby="ConnectedServices-tab">
                                                                <a href="mailto:"> <img src="image/gmail.png" alt="" width="30" height="20"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="tel:" ><img src="image/mobile.png" alt="" width="50" height="30"></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
