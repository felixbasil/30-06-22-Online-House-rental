...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <!-- Content Wrapper -->
            <div id="content-wrapper" class="d-flex flex-column" style="background: url(image/img4.jpg) no-repeat center center fixed; background-size: cover; -o-background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;">
                    ...
                    <form action="<=request.getContextPath()%>/EditClientProfile"  method="post" class="modal-body" novalidate>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="username" id="validationCustom03" placeholder="Username" value= readonly>   
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
