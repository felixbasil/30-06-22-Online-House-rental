...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <!-- Content Wrapper -->
            <div id="content-wrapper" class="d-flex flex-column" style="background: url(image/img2.jpg) no-repeat center center fixed; background-size: cover; -o-background-size: cover; -moz-background-size: cover; -webkit-background-size: cover;">
        ...
        <div class="modal fade" id="ProfileModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document" >
                <div class="modal-content">
                    ...
                    <form action="equest.getContextPath()/EditAdminProfile"  method="post" class="modal-body" novalidate>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="gender" id="validationCustom03" placeholder="Gender" value="<.getString(8)">       
                            </div>
                            <div class="col-md-6 mb-3">
